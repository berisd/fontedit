...
static BRS_GUI_Widget *createMenuBar(BRS_Font *font) {
    ...
    BRS_GUI_Widget *widget = BRS_GUI_createMenuBar(menuBarPosition, menuBarDimension, &COLOR_BLUE, font);
...
BRS_GUI_WidgetList *createWidgets(BRS_Font *font) {
    ...
    BRS_GUI_WidgetList_push(
            BRS_GUI_createLabel(labelPosition, &COLOR_RED, "Hello World", font), list);
